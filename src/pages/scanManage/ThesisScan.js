...
import viewImg from "../../assets/history.png";
const { Search } = Input;
    ...
    <>
      ...
      <div>
        ...
        <Modal
          ...
          width={800}
        >
          <p>本链接为临时链接，一共还可以获取n次，点击链接后进入如图网页，可以下载pdf版报告至本地电脑</p>
          <Image src={viewImg} alt="viewImg"/>
        </Modal>
      ...
      >
        ...
        <Flex justify="space-evenly">
            <Button color="danger" variant="solid" onClick={()=>{message.success("下线成功")}}>下线</Button>
            <Button color="danger" variant="solid" onClick={()=>{message.success("删除成功")}}>删除</Button>
